...
import pages.P03_AccountInfoPage;
...
public class TC03_AccountInfoTest {
    ...
    @Test
    public void verifyTextVisibilityTC() throws IOException {
        ...
        Assert.assertTrue(new P03_AccountInfoPage(getDriver()).verifyTextVisibility());
    }

    @Test
    public void fillAccountInfoTC() throws IOException {
        new P01_HomePage(getDriver()).clickOnSignupButton()
                .enterName(readDataFromJsonFile("signupInformation", "name"))
                .enterEmail(readDataFromJsonFile("signupInformation", "email"))
                .clickSignupButton()
        ...
        Assert.assertTrue(Utility.verifyURL(getDriver(), readDataFromProperties("environments", "ACCOUNT_CREATED_URL")));
    }
